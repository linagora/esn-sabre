...
class IMipPluginRecurrentEventWithTZTest extends IMipPluginTestBase {
    ...
    function testCreateRecurringEventWithAttendee()
    {
        ...
        $scheduledIcal = join("\r\n", [
            ...
            'DTEND;TZID=Asia/Jakarta:20501028T173000',
    ...
    function testRemoveInstanceFromRecurringEvent()
    {
        ...
        $scheduledIcal = join("\r\n", [
            ...
            'UID:ab9e450a-3080-4274-affd-fdd0e9eefdcc',
            'RRULE:FREQ=DAILY',
            'EXDATE;TZID=Asia/Jakarta:'. $this->afterCurrentDate.'T170000',
            'DTSTART;TZID=Asia/Jakarta:'. $this->afterCurrentDate.'T173000',
            'DTEND;TZID=Asia/Jakarta:'. $this->afterCurrentDate.'T173000',
            'SUMMARY:Test',
            'ORGANIZER:mailto:' . $this->user1Email,
            'ATTENDEE:mailto:' . $this->user1Email,
        ...
        $expectedMessageEvent = join("\r\n", [
            ...
            'SEQUENCE:0',
            'DTSTART;TZID=Asia/Jakarta:'. $this->afterCurrentDate.'T170000',
            'DTEND;TZID=Asia/Jakarta:'. $this->afterCurrentDate.'T170000',
            'RECURRENCE-ID;TZID=Asia/Jakarta:'. $this->afterCurrentDate.'T170000',
            'STATUS:CANCELLED',
            'END:VEVENT',
            'END:VCALENDAR',
